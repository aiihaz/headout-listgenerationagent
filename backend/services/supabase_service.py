...
async def list_runs(limit: int = 50) -> list[dict[str, Any]]:
    ...
    try:
        resp = (
            client.table("runs")
            .select("id,status,supplier_input,supplier_name,supplier_city,supplier_id,experience_name,created_at,updated_at,error_message,flag_count,created_by_email")
